      ...
      <div class="container">
        <div id="menu" class="collapse navbar-collapse">
          <ul class="nav navbar-nav ml-auto">   
            ...
            <li class="nav-item"><a class="nav-link" href="help.php" disabled>Help</a></li>
	...
	<div id="home-content-parent">
		<div id="home-content-child" class="text-center">
			...
			<div id="home-text">
				<p id="paragraphe">
					<br><br>
                    Reservini is a platform that allows event makers to announce their events. Also, it grants normal users the ability to book events.
				</p>
			</div><br><br><br>
