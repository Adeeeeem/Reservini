...
<section id="home">
	...
	<div id="home-content-parent">
		<div id="home-content-child" class="text-center">
			...
			<div id="home-text">
				<p>
					<br><br>To achieve great things, two things are needed: a plan and not quite enough time.<br>
					<span>Leonard Bernstein</span>
				</p>
			</div><br><br><br>
			<a class="btn add-btn" href="logsign.php">Add an Event</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   			<a class="btn book-btn" href="logsign.php">Book an Event</a>
		</div>  
	</div>
